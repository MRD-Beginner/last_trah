                                ...
                                <td style="overflow: hidden;">
                                    <div
                                        ...
                                        <div class="d-flex d-md-none justify-content-center gap-1 w-100">
                                            ...
                                            <a class="btn btn-sm btn-info rounded-circle p-2 mobile-icon"
                                                href="{{ route('admin.dashboard') }}" data-bs-toggle="tooltip"
                                        ...
                                        <div class="d-none d-md-flex flex-wrap justify-content-center gap-2">
                                            ...
                                            <a class="btn btn-sm btn-info rounded-pill px-2 py-1" href="#"
                                                onclick="copyShareLink(event, '{{ '127.0.0.1/detail/public/' . $Trah->id }}')">
                                                Bagikan
                                            </a>

                                            <script>
                                                async function copyShareLink(event, url) {
